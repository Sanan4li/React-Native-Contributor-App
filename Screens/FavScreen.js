    ...
    if(this.state.selectedProvice!="Select Province"){
      ...
      return (
          <View style={styles.main}>
            <View style={{alignItems:"center", backgroundColor:"#e6f4ff", padding:30, borderRadius:10}}>
            <Text style={{fontSize:15, color:"black"}}>A volunteer is one who want to help people by doing work like distributing food, mananging process etc.</Text>
           
            </View>
            <View style={{backgroundColor:"#eae6ff", padding:20,borderRadius:10, marginTop:30}}>
          ...
          <View>
              <TouchableOpacity onPress={()=>this.props.navigation.navigate("FoodHubList", {city:this.state.selectedCity})}>
                  <Text style={styles.button}>Get List</Text>
              </TouchableOpacity>
          </View>
          </View>
      )
