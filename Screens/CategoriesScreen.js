      ...
      if(this.state.selectedProvice!="Select Province"){
        ...
        return (
            <View style={styles.main}>
              ...
              <Text style={{fontSize:15, color:"black"}}>A contributer is one who is willing to donate money to poor people of a specific area.</Text>
            ...
            <View>
                <TouchableOpacity onPress={()=>this.props.navigation.navigate("BankAccounts", {city:this.state.selectedCity})}>
